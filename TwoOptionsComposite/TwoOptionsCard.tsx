...
export const TwoOptionsCard = ({card, name, isVisible , width, height, onCardClicked}: ITwoOptionsCardProperties) : JSX.Element => {
    ...
    return  <Stack key={card.control.attributes?.LogicalName} onClick={onClick} tokens={{ childrenGap: 2 }} verticalFill={true} style={{width: `${width}px`, height: `${height}px`, alignItems: "center" , border: `1px solid ${color}`}}>
